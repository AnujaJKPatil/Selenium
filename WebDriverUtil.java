...
public class WebDriverUtil {
	...
	public void switchWindow(WebDriver d, String expectedUrl) {
		...
		for(String e : ids) {
			String url1 = d.switchTo().window(e).getCurrentUrl();
			
			if(url1.contains(expectedUrl)) {
				break;
			}
		}
	}
	...
	public File screenshot(WebDriver d, String screenshotname) throws IOException {
		...
		File desti = new File("./Screenshot/"+screenshotname+".png");
		FileUtils.copyFile(tempfile, desti);
		return desti;
	}
}
